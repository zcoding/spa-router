var Router = (function () {
  ...
  var RNode = function () {
    ...
    babelHelpers.createClass(RNode, [{
      key: 'children',
  ...
  var Router = function () {
    ...
    babelHelpers.createClass(Router, [{
      ...
      value: function dispatch(path) {
        ...
        if (callbacks !== null) {
          if (Array.isArray(callbacks)) {
            ...
            throw new TypeError('Expected Array, got ' + (typeof callbacks === 'undefined' ? 'undefined' : babelHelpers.typeof(callbacks)));
          }
      ...
      key: 'once',
      value: function once(path, handlers) {
        return this;
      }
